...
function main(config) {
  ...
  const dlAnchor = { "type": "select", "proxies": ["代理连接", "直接连接", "最低延迟", "智能选择", "香港|智能选择", "台湾|智能选择", "新加坡|智能选择", "日本|智能选择", "美国|智能选择", "德国|智能选择", "英国|智能选择", "荷兰|智能选择"], "include-all-providers": true, "empty-fallback": "REJECT" };
  ...
  return { 
    ...
    "proxy-groups": [
      { "name": "代理连接", "type": "select", "proxies": ["最低延迟", "智能选择", "香港|智能选择", "台湾|智能选择", "新加坡|智能选择", "日本|智能选择", "美国|智能选择", "德国|智能选择", "英国|智能选择", "荷兰|智能选择"], "include-all-providers": true, "icon": "https://raw.githubusercontent.com/kongbaitt/proxy/main/img/Hand-Painted-icon/Universal/StreamingSE.png" },
      ...
      { "name": "智能选择", ...smartAnchor, "filter": "(?i)🇭🇰|香港|\\bHK\\b|\\bhongkong\\b|\\bhong\s?kong\\b|🇸🇬|新加坡|狮城|\\bSG\\b|\\bsingapore\\b|🇯🇵|日本|\\bJP\\b|\\bjapan\\b|🇺🇸|美国|\\bUS\\b|\\bunitedstates\\b|\\bunited\s?states\\b", "icon": "https://raw.githubusercontent.com/kongbaitt/proxy/main/img/Hand-Painted-icon/Universal/Final.png" },
      { "name": "香港|智能选择", ...smartAnchor, "filter": "(?i)🇭🇰|香港|\\bHK\\b|\\bhongkong\\b|\\bhong\\s?kong\\b", "icon": "https://raw.githubusercontent.com/kongbaitt/proxy/main/img/Hand-Painted-icon/Rounded_Rectangle/Hong_Kong.png" },
      { "name": "台湾|智能选择", ...smartAnchor, "filter": "(?i)🇹🇼|台湾|\\bTW\\b|\\btaiwan\\b", "icon": "https://raw.githubusercontent.com/kongbaitt/proxy/main/img/Hand-Painted-icon/Rounded_Rectangle/Taiwan.png" },
      { "name": "新加坡|智能选择", ...smartAnchor, "filter": "(?i)🇸🇬|新加坡|狮城|\\bSG\\b|\\bsingapore\\b", "icon": "https://raw.githubusercontent.com/kongbaitt/proxy/main/img/Hand-Painted-icon/Rounded_Rectangle/Singapore.png" },
      { "name": "日本|智能选择", ...smartAnchor, "filter": "(?i)🇯🇵|日本|\\bJP\\b|\\bjapan\\b", "icon": "https://raw.githubusercontent.com/kongbaitt/proxy/main/img/Hand-Painted-icon/Rounded_Rectangle/Japan.png" },
      { "name": "美国|智能选择", ...smartAnchor, "filter": "(?i)🇺🇸|美国|\\bUS\\b|\\bunitedstates\\b|\\bunited\\s?states\\b", "icon": "https://raw.githubusercontent.com/kongbaitt/proxy/main/img/Hand-Painted-icon/Rounded_Rectangle/United_States.png" },
      { "name": "德国|智能选择", ...smartAnchor, "filter": "(?i)🇩🇪|德国|\\bDE\\b|\\bgermany\\b", "icon": "https://raw.githubusercontent.com/kongbaitt/proxy/main/img/Hand-Painted-icon/Rounded_Rectangle/Germany.png" },
      { "name": "英国|智能选择", ...smartAnchor, "filter": "(?i)🇬🇧|英国|\\bUK\\b|\\bGB\\b|\\bunitedkingdom\\b|\\bunited\\s?kingdom\\b", "icon": "https://raw.githubusercontent.com/kongbaitt/proxy/main/img/Hand-Painted-icon/Rounded_Rectangle/United_Kingdom.png" },
      { "name": "荷兰|智能选择", ...smartAnchor, "filter": "(?i)🇳🇱|荷兰|\\bNL\\b|\\bnetherlands?\\b", "icon": "https://raw.githubusercontent.com/kongbaitt/proxy/main/img/Hand-Painted-icon/Rounded_Rectangle/Netherlands.png" },
      { "name": "GLOBAL", "type": "select", "proxies": ["最低延迟", "智能选择", "香港|智能选择", "台湾|智能选择", "新加坡|智能选择", "日本|智能选择", "美国|智能选择", "德国|智能选择", "英国|智能选择", "荷兰|智能选择", "代理连接", "直接连接", "代理DNS", "代理QUIC", "TELEGRAM", "国外AI", "下载相关", "风控安全", "GOOGLE", "海外媒体"], "include-all-providers": true, "hidden": true, "icon": "https://raw.githubusercontent.com/kongbaitt/proxy/main/img/Hand-Painted-icon/Google_Suite/Browser.png" }
    ]
  };
}
